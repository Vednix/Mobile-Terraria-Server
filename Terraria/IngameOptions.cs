	...
	public static class IngameOptions
	{
		...
		public static void Draw(Main mainInstance, SpriteBatch sb)
		{
			...
			if (category == 0)
			{
				int num9 = 0;
				anchor2.X -= 70f;
				if (DrawRightSide(sb, Lang.menu[99] + " " + Math.Round(Main.musicVolume * 100f) + "%", num9, anchor2, offset2, rightScale[num9], (rightScale[num9] - num2) / (num3 - num2)))
				{
					if (rightLock == -1)
					{
						notBar = true;
				...
				num9++;
				if (DrawRightSide(sb, Lang.menu[98] + " " + Math.Round(Main.soundVolume * 100f) + "%", num9, anchor2, offset2, rightScale[num9], (rightScale[num9] - num2) / (num3 - num2)))
				{
					if (rightLock == -1)
					{
						notBar = true;
				...
				num9++;
				if (DrawRightSide(sb, Lang.menu[119] + " " + Math.Round(Main.ambientVolume * 100f) + "%", num9, anchor2, offset2, rightScale[num9], (rightScale[num9] - num2) / (num3 - num2)))
				{
					if (rightLock == -1)
					{
						notBar = true;
				...
				num9++;
				if (DrawRightSide(sb, Lang.menu[123] + " " + Lang.menu[124 + Main.invasionProgressMode], num9, anchor2, offset2, rightScale[num9], (rightScale[num9] - num2) / (num3 - num2)))
				{
					rightHover = num9;
					if (flag)
					{
			...
			if (category == 1)
			{
				...
				num10++;
				if (DrawRightSide(sb, Lang.menu[51] + ": " + Main.PendingResolutionWidth + "x" + Main.PendingResolutionHeight, num10, anchor2, offset2, rightScale[num10], (rightScale[num10] - num2) / (num3 - num2)))
				{
					rightHover = num10;
					if (flag)
					{
				...
				num10++;
				anchor2.X -= 70f;
				if (DrawRightSide(sb, Lang.menu[52] + ": " + Main.bgScroll + "%", num10, anchor2, offset2, rightScale[num10], (rightScale[num10] - num2) / (num3 - num2)))
				{
					if (rightLock == -1)
					{
						notBar = true;
				...
				num10++;
				if (DrawRightSide(sb, Lang.menu[116] + " " + ((Lighting.LightingThreads > 0) ? string.Concat(Lighting.LightingThreads + 1) : Lang.menu[117].Value), num10, anchor2, offset2, rightScale[num10], (rightScale[num10] - num2) / (num3 - num2)))
				{
					rightHover = num10;
					if (flag)
					{
