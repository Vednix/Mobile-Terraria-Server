	...
	public class MessageBuffer
	{
		...
		public void GetData(int start, int length, out int messageType)
		{
			...
			case 8:
			{
				...
				int num40 = 1;
				PortalHelper.SyncPortalsOnPlayerJoin(whoAmI, 1, list, out List<Point> portals, out List<Point> portalCenters);
				num36 += portals.Count;
				...
				if (flag)
				{
					for (int num43 = num30; num43 < num37; num43++)
					{
						...
						{
							NetMessage.SendSection(whoAmI, num43, num44, skipSent: true);
						}
					}
				...
				{
					NetMessage.SendSection(whoAmI, portals[num45].X, portals[num45].Y, skipSent: true);
				}
			...
			case 17:
			{
				...
				if (b12 == 1)
				{
					WorldGen.PlaceTile(num162, num163, num164, mute: false, forced: true, -1, num165);
				}
				if (b12 == 2)
				{
				...
				if (b12 == 4)
				{
					WorldGen.KillTile(num162, num163, flag7, effectOnly: false, noItem: true);
				}
				if (b12 == 5)
				{
				...
				if (b12 == 15)
				{
					Minecart.FrameTrack(num162, num163, pound: true);
				}
				if (Main.netMode == 2)
				{
			...
			case 19:
			{
				...
				if (WorldGen.InWorld(num20, num21, 3))
				{
					...
					case 0:
						...
						break;
					case 1:
						WorldGen.CloseDoor(num20, num21, forced: true);
						break;
					case 2:
					...
					case 3:
						...
						break;
					case 4:
						WorldGen.ShiftTallGate(num20, num21, closing: false);
						break;
					case 5:
						WorldGen.ShiftTallGate(num20, num21, closing: true);
						break;
					}
					if (Main.netMode == 2)
					{
			...
			case 90:
			{
				...
				if (Main.netMode == 1)
				{
					...
					bool newAndShiny = (item2.newAndShiny || item2.netID != num107) && ItemSlot.Options.HighlightNewItems && (num107 < 0 || num107 >= 3602 || !ItemID.Sets.NeverShiny[num107]);
				...
				else
				{
					...
					if (flag4)
					{
						...
						num105 = Item.NewItem((int)position2.X, (int)position2.Y, item3.width, item3.height, item3.type, stack3, noBroadcast: true);
					}
			...
			case 25:
			{
				...
				else
				{
					...
					{
						NetMessage.SendData(25, -1, -1, "*" + Main.player[whoAmI].name + " " + Lang.mp[9] + " " + Main.rand.Next(1, 101), 16, 255f, 240f, 20f);
					}
			...
			case 26:
			{
				...
				if (Main.netMode != 2 || whoAmI == num101 || (Main.player[num101].hostile && Main.player[whoAmI].hostile))
				{
					...
					Main.player[num101].Hurt(num103, num102, flag2, quiet: true, text6, flag3, num104);
					if (Main.netMode == 2)
					{
			...
			case 28:
			{
				...
				if (num180 >= 0)
				{
					Main.npc[num179].StrikeNPC(num180, num181, num182, b13 == 1, noEffect: false, fromNet: true);
				}
				else
				{
			...
			case 34:
			{
				...
				if (Main.netMode == 2)
				{
					...
					case 0:
					{
						int num86 = WorldGen.PlaceChest(num83, num84, 21, notNearOtherChests: false, num85);
						if (num86 == -1)
						{
							NetMessage.SendData(34, whoAmI, -1, "", b9, num83, num84, num85, num86);
							Item.NewItem(num83 * 16, num84 * 16, 32, 32, Chest.chestItemSpawn[num85], 1, noBroadcast: true);
						}
						else
						{
					...
					case 2:
					{
						int num87 = WorldGen.PlaceChest(num83, num84, 88, notNearOtherChests: false, num85);
						if (num87 == -1)
						{
							NetMessage.SendData(34, whoAmI, -1, "", b9, num83, num84, num85, num87);
							Item.NewItem(num83 * 16, num84 * 16, 32, 32, Chest.dresserItemSpawn[num85], 1, noBroadcast: true);
						}
						else
						{
			...
			case 53:
			{
				...
				Main.npc[num113].AddBuff(type6, time, quiet: true);
				if (Main.netMode == 2)
				{
			...
			case 66:
			{
				...
				if (num193 > 0)
				{
					...
					player17.HealEffect(num193, broadcast: false);
					if (Main.netMode == 2)
					{
			...
			case 79:
			{
				...
				WorldGen.PlaceObject(x3, y3, type4, mute: false, style2, num65, random, direction);
				if (Main.netMode == 2)
				{
			...
			case 86:
			{
				...
				{
					if (TileEntity.ByID.TryGetValue(key, out TileEntity value2) && (value2 is TETrainingDummy || value2 is TEItemFrame))
					{
