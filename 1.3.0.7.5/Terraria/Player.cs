...
namespace Terraria
{
	public class Player : Entity
	{
		...
		public void dropItemCheck()
		{
			...
			{
				inventory[selectedItem] = GetItem(whoAmI, inventory[selectedItem], longText: false, noText: true);
				if (selectedItem == 58)
				{
		...
		public void QuickGrapple()
		{
			...
			Item item = null;
			if (item == null && Main.projHook[miscEquips[4].shoot])
			{
				item = miscEquips[4];
			}
			if (item == null)
		...
		public void openCrate(int type)
		{
			...
			case 0:
			{
				...
				while (flag2)
				{
					...
					if (flag2 && Main.rand.Next(40) == 0)
					{
						int type10 = 3200;
						int stack10 = 1;
						int number13 = Item.NewItem((int)position.X, (int)position.Y, width, height, type10, stack10, noBroadcast: false, -1);
						if (Main.netMode == 1)
						{
							NetMessage.SendData(21, -1, -1, "", number13, 1f);
						}
					...
					if (flag2 && Main.rand.Next(40) == 0)
					{
						int type11 = 3201;
						int stack11 = 1;
						int number14 = Item.NewItem((int)position.X, (int)position.Y, width, height, type11, stack11, noBroadcast: false, -1);
						if (Main.netMode == 1)
						{
							NetMessage.SendData(21, -1, -1, "", number14, 1f);
						}
					...
					if (Main.hardMode && flag2 && Main.rand.Next(25) == 0)
					{
						int type12 = 2424;
						int stack12 = 1;
						int number15 = Item.NewItem((int)position.X, (int)position.Y, width, height, type12, stack12, noBroadcast: false, -1);
						if (Main.netMode == 1)
						{
							NetMessage.SendData(21, -1, -1, "", number15, 1f);
						}
					...
					if (Main.rand.Next(45) == 0)
					{
						...
						int number16 = Item.NewItem((int)position.X, (int)position.Y, width, height, num5, 1, noBroadcast: false, -1);
						if (Main.netMode == 1)
						{
							NetMessage.SendData(21, -1, -1, "", number16, 1f);
						}
			...
			case 1:
			{
				...
				while (flag)
				{
					...
					if (flag && Main.rand.Next(15) == 0)
					{
						int type4 = 2608;
						int stack3 = 1;
						int number4 = Item.NewItem((int)position.X, (int)position.Y, width, height, type4, stack3, noBroadcast: false, -1);
						if (Main.netMode == 1)
						{
							NetMessage.SendData(21, -1, -1, "", number4, 1f);
						}
					...
					if (flag && Main.rand.Next(20) == 0)
					{
						int type5 = 3200;
						int stack4 = 1;
						int number5 = Item.NewItem((int)position.X, (int)position.Y, width, height, type5, stack4, noBroadcast: false, -1);
						if (Main.netMode == 1)
						{
							NetMessage.SendData(21, -1, -1, "", number5, 1f);
						}
					...
					if (flag && Main.rand.Next(20) == 0)
					{
						int type6 = 3201;
						int stack5 = 1;
						int number6 = Item.NewItem((int)position.X, (int)position.Y, width, height, type6, stack5, noBroadcast: false, -1);
						if (Main.netMode == 1)
						{
							NetMessage.SendData(21, -1, -1, "", number6, 1f);
						}
			...
			while (flag4)
			{
				if (num == 3 && flag4 && Main.rand.Next(maxValue) == 0)
				{
					...
					int number31 = Item.NewItem((int)position.X, (int)position.Y, width, height, type20, 1, noBroadcast: false, -1);
					if (Main.netMode == 1)
					{
				...
				if (num == 4 && flag4 && Main.rand.Next(maxValue) == 0)
				{
					...
					int number32 = Item.NewItem((int)position.X, (int)position.Y, width, height, type21, 1, noBroadcast: false, -1);
					if (Main.netMode == 1)
					{
				...
				{
					int type22 = 3085;
					int number33 = Item.NewItem((int)position.X, (int)position.Y, width, height, type22, 1, noBroadcast: false, -1);
					if (Main.netMode == 1)
					{
				...
				if (num == 6 && flag4 && Main.rand.Next(maxValue) == 0)
				{
					...
					int number34 = Item.NewItem((int)position.X, (int)position.Y, width, height, type23, 1, noBroadcast: false, -1);
					if (Main.netMode == 1)
					{
				...
				if (num == 8 && flag4 && Main.rand.Next(maxValue) == 0)
				{
					...
					int number35 = Item.NewItem((int)position.X, (int)position.Y, width, height, type24, 1, noBroadcast: false, -1);
					if (Main.netMode == 1)
					{
		...
		public void openLockBox()
		{
			...
			while (flag)
			{
				...
				int number = Item.NewItem((int)position.X, (int)position.Y, width, height, num, 1, noBroadcast: false, -1);
				if (Main.netMode == 1)
				{
					NetMessage.SendData(21, -1, -1, "", number, 1f);
				}
			...
			for (int k = 0; k < 22; k++)
			{
				...
				else if (buffType[k] == 116)
				{
					...
					for (int m = 0; m < 16; m++)
					{
						...
						if (flag)
						{
							player.Hurt(num3, 0, pvp: true, quiet: false, "");
							if (Main.netMode != 0)
							{
				...
				{
					mount.SetMount(6, this, faceLeft: true);
					buffTime[k] = 10;
				}
				...
				{
					mount.SetMount(11, this, faceLeft: true);
					buffTime[k] = 10;
				}
				...
				{
					mount.SetMount(13, this, faceLeft: true);
					buffTime[k] = 10;
				}
			...
			for (int k = 0; k < 8 + extraAccessorySlots; k++)
			{
				...
				if (armor[k].type == 3017 && whoAmI == Main.myPlayer && velocity.Y == 0f && grappling[0] == -1)
				{
					...
					if (!Main.tile[num, num2].active() && Main.tile[num, num2].liquid == 0 && Main.tile[num, num2 + 1] != null && WorldGen.SolidTile(num, num2 + 1))
					{
						...
						Main.tile[num, num2].halfBrick(halfBrick: false);
		...
		public void SmartCursorLookup()
		{
			...
			{
				SmartCursor_Axe(item, ref mouse, value, value2, value3, value4, ref fX, ref fY);
			}
			if (item.pick > 0 && fX == -1 && fY == -1)
			{
				...
				_ = (int)base.Center.X / 16;
				_ = (int)base.Center.Y / 16;
				...
				while (list2.Count > 0)
				{
					...
					if (!Collision.TupleHitLine(tuple.Item1, tuple.Item2, tuple2.Item1, tuple2.Item2, num4 * (int)gravDir, -num5 * (int)gravDir, list, out Tuple<int, int> col))
					{
						list2.Remove(tuple);
						list3.Remove(tuple2);
						continue;
			...
			if ((item.type == 509 || item.type == 850 || item.type == 851) && fX == -1 && fY == -1)
			{
			...
			if (item.hammer > 0 && fX == -1 && fY == -1)
			{
				...
				while (list7.Count > 0)
				{
					...
					_ = Main.tile[tuple7.Item1, tuple7.Item2];
			...
			if (item.createTile == 19 && fX == -1 && fY == -1)
			{
			...
			if ((item.type == 2340 || item.type == 2739) && fX == -1 && fY == -1)
			{
			...
			if (item.createWall > 0 && fX == -1 && fY == -1)
			{
			...
			if (SmartCursorSettings.SmartBlocksEnabled && item.createTile > -1 && item.type != 213 && Main.tileSolid[item.createTile] && !Main.tileSolidTop[item.createTile] && !Main.tileFrameImportant[item.createTile] && fX == -1 && fY == -1)
			{
			...
			if ((item.type == 1072 || item.type == 1544) && num3 != 0 && fX == -1 && fY == -1)
			{
			...
			if ((item.type == 1071 || item.type == 1543) && num3 != 0 && fX == -1 && fY == -1)
			{
			...
			if ((item.type == 1100 || item.type == 1545) && fX == -1 && fY == -1)
			{
			...
			if (item.type == 27 && fX == -1 && fY == -1 && value3 > 20)
			{
			...
			if (item.createTile == 82 && fX == -1 && fY == -1)
			{
			...
			if (item.createTile == 380 && fX == -1 && fY == -1)
			{
			...
			if (item.createTile == 78 && fX == -1 && fY == -1)
			{
				...
				if (list26.Count > 0)
				{
					...
					{
						if (Collision.EmptyTile(list26[num132].Item1, list26[num132].Item2, ignoreTiles: true))
						{
		...
		public void UpdateLifeRegen()
		{
			...
			if (burned || suffocating || (tongued && Main.expertMode))
			{
				while (lifeRegenCount <= -600)
				{
					lifeRegenCount += 600;
					statLife -= 5;
					CombatText.NewText(new Rectangle((int)position.X, (int)position.Y, width, height), CombatText.LifeRegen, string.Concat(5), dramatic: false, dot: true);
					if (statLife <= 0 && whoAmI == Main.myPlayer)
					{
						if (suffocating)
						{
							KillMe(10.0, 0, pvp: false, Language.GetTextValue("DeathText.Suffocated", Main.player[Main.myPlayer].name));
						}
						else
						{
							KillMe(10.0, 0, pvp: false, Language.GetTextValue("DeathText.Burned", Main.player[Main.myPlayer].name));
						}
					}
				}
				return;
			...
			while (lifeRegenCount <= -120)
			{
				if (lifeRegenCount <= -480)
				{
					lifeRegenCount += 480;
					statLife -= 4;
					CombatText.NewText(new Rectangle((int)position.X, (int)position.Y, width, height), CombatText.LifeRegen, string.Concat(4), dramatic: false, dot: true);
				}
				else if (lifeRegenCount <= -360)
				{
					lifeRegenCount += 360;
					statLife -= 3;
					CombatText.NewText(new Rectangle((int)position.X, (int)position.Y, width, height), CombatText.LifeRegen, string.Concat(3), dramatic: false, dot: true);
				}
				else if (lifeRegenCount <= -240)
				{
					lifeRegenCount += 240;
					statLife -= 2;
					CombatText.NewText(new Rectangle((int)position.X, (int)position.Y, width, height), CombatText.LifeRegen, string.Concat(2), dramatic: false, dot: true);
				}
				else
				{
					lifeRegenCount += 120;
					statLife--;
					CombatText.NewText(new Rectangle((int)position.X, (int)position.Y, width, height), CombatText.LifeRegen, string.Concat(1), dramatic: false, dot: true);
				}
				if (statLife <= 0 && whoAmI == Main.myPlayer)
				{
					if (poisoned || venom)
					{
						KillMe(10.0, 0, pvp: false, Language.GetTextValue("DeathText.Poisoned", Main.player[Main.myPlayer].name));
					}
					else if (electrified)
					{
						KillMe(10.0, 0, pvp: false, Language.GetTextValue("DeathText.Electrocuted", Main.player[Main.myPlayer].name));
					}
					else
					{
						KillMe(10.0, 0, pvp: false, Language.GetTextValue("DeathText.Burned", Main.player[Main.myPlayer].name));
		...
		public void WOFTongue()
		{
			...
			{
				noKnockback = false;
				Hurt(50, Main.npc[Main.wof].direction, pvp: false, quiet: false, Lang.deathMsg(name, -1, -1, -1, 4));
			}
			...
			if (num4 > 3000f)
			{
				KillMe(1000.0, 0, pvp: false, Language.GetTextValue("DeathText.TriedToEscape", Main.player[Main.myPlayer].name));
			}
			else if (Main.npc[Main.wof].position.X < 608f || Main.npc[Main.wof].position.X > (float)((Main.maxTilesX - 38) * 16))
			{
				KillMe(1000.0, 0, pvp: false, Language.GetTextValue("DeathText.WasLicked", Main.player[Main.myPlayer].name));
			}
		}
				...
				if (flag)
				{
					...
					if (breathCD >= num4)
					{
						...
						if (breath <= 0)
						{
							...
							{
								statLife = 0;
								KillMe(10.0, 0, pvp: false, Lang.deathMsg(name, -1, -1, -1, 1));
							}
						}
					}
				}
		...
		public void Update(int i)
		{
			...
			if (i == Main.myPlayer)
			{
				...
				if (stoned != lastStoned)
				{
					if (whoAmI == Main.myPlayer && stoned)
					{
						...
						Hurt(damage, 0, pvp: false, quiet: false, Lang.deathMsg(name, -1, -1, -1, 4));
					}
				...
				if (base.velocity.Y == 0f)
				{
					...
					if (stoned)
					{
						...
						if (num28 > 0)
						{
							Hurt(num28, 0, pvp: false, quiet: false, Lang.deathMsg(name, -1, -1, -1, 4));
							immune = false;
						}
					}
					else if (((gravDir == 1f && num26 > num25) || (gravDir == -1f && num26 < -num25)) && !noFallDmg && !flag17)
					{
						...
						Hurt(num29, 0, pvp: false, quiet: false, Lang.deathMsg(name, -1, -1, -1, 0));
							...
							if (releaseUseTile)
							{
								...
								else if (Main.tile[tileTargetX, tileTargetY].type == 334)
								{
									...
									else
									{
										...
										if (frameX >= 5000)
										{
											WorldGen.KillTile(tileTargetX, num180, fail: true);
											if (Main.netMode == 1)
											{
								...
								else if (Main.tile[tileTargetX, tileTargetY].type == 395)
								{
									...
									else
									{
										...
										{
											WorldGen.KillTile(tileTargetX, num184, fail: true);
											if (Main.netMode == 1)
											{
			...
			if (Main.myPlayer == whoAmI)
			{
				...
				for (int num243 = 0; num243 < 200; num243++)
				{
					...
					Hurt(num249, num248, pvp: false, quiet: false, Lang.deathMsg(name, -1, num243), Crit: false, num244);
				}
				...
				else if (vector6.Y != 0f)
				{
					...
					Hurt(damage3, 0, pvp: false, quiet: false, Lang.deathMsg(name, -1, -1, -1, 3), Crit: false, 0);
				}
				else
				{
					suffocateDelay = 0;
			...
			if (flag36)
			{
				if (!lavaImmune && Main.myPlayer == i && !immune)
				{
					...
					{
						Hurt(50, 0, pvp: false, quiet: false, Lang.deathMsg(name, -1, -1, -1, 2));
						AddBuff(24, 210);
					}
					else
					{
						Hurt(80, 0, pvp: false, quiet: false, Lang.deathMsg(name, -1, -1, -1, 2));
						AddBuff(24, 420);
					}
				}
				lavaWet = true;
			...
			if (mount.Active && mount.Cart)
			{
				...
				DelegateMethods.Minecart.rotation = fullRotation;
				DelegateMethods.Minecart.rotationOrigin = fullRotationOrigin;
				BitsByte bitsByte = Minecart.TrackCollision(ref base.position, ref base.velocity, ref lastBoost, width, height, controlDown, controlUp, fallStart2, trackOnly: false, mount.MinecartDust);
				if (bitsByte[0])
				{
					onTrack = true;
					...
					if (paladinBuff && whoAmI != Main.myPlayer)
					{
						...
						if (Main.player[Main.myPlayer].paladinGive)
						{
							...
							if (Main.player[myPlayer].team == team && team != 0)
							{
								...
								if (num9 < 800f)
								{
									Main.player[myPlayer].Hurt(damage, 0, pvp: false, quiet: false, "");
								}
							}
						}
					}
		...
		public Item GetItem(int plr, Item newItem, bool longText = false, bool noText = false)
		{
			...
			for (int i = num2; i < 50; i++)
			{
				...
				if (item.stack + inventory[num3].stack <= inventory[num3].maxStack)
				{
					...
					if (!noText)
					{
						ItemText.NewText(newItem, item.stack, noStack: false, longText);
					}
					DoCoins(num3);
					if (plr == Main.myPlayer)
					{
				...
				AchievementsHelper.NotifyItemPickup(this, item, inventory[num3].maxStack - inventory[num3].stack);
				item.stack -= inventory[num3].maxStack - inventory[num3].stack;
				if (!noText)
				{
					ItemText.NewText(newItem, inventory[num3].maxStack - inventory[num3].stack, noStack: false, longText);
				}
			...
			if (newItem.type != 71 && newItem.type != 72 && newItem.type != 73 && newItem.type != 74 && newItem.useStyle > 0)
			{
				for (int j = 0; j < 10; j++)
				{
					if (inventory[j].type == 0)
					{
						...
						if (!noText)
						{
							ItemText.NewText(newItem, newItem.stack, noStack: false, longText);
						}
						DoCoins(j);
						if (flag)
						{
		...
		public void PlaceThing()
		{
			...
			else if (inventory[selectedItem].createTile >= 0 && position.X / 16f - (float)tileRangeX - (float)inventory[selectedItem].tileBoost - (float)blockRange <= (float)tileTargetX && (position.X + (float)width) / 16f + (float)tileRangeX + (float)inventory[selectedItem].tileBoost - 1f + (float)blockRange >= (float)tileTargetX && position.Y / 16f - (float)tileRangeY - (float)inventory[selectedItem].tileBoost - (float)blockRange <= (float)tileTargetY && (position.Y + (float)height) / 16f + (float)tileRangeY + (float)inventory[selectedItem].tileBoost - 2f + (float)blockRange >= (float)tileTargetY)
			{
				...
				if (flag2 && ((!Main.tile[tileTargetX, tileTargetY].active() && !flag) || Main.tileCut[Main.tile[tileTargetX, tileTargetY].type] || (Main.tile[tileTargetX, tileTargetY].type >= 373 && Main.tile[tileTargetX, tileTargetY].type <= 375) || inventory[selectedItem].createTile == 199 || inventory[selectedItem].createTile == 23 || inventory[selectedItem].createTile == 2 || inventory[selectedItem].createTile == 109 || inventory[selectedItem].createTile == 60 || inventory[selectedItem].createTile == 70 || TileID.Sets.BreakableWhenPlacing[Main.tile[tileTargetX, tileTargetY].type]) && itemTime == 0 && itemAnimation > 0 && controlUseItem)
				{
					...
					if (flag3)
					{
						...
						{
							flag6 = WorldGen.PlaceTile(tileTargetX, tileTargetY, inventory[selectedItem].createTile, mute: false, forced, whoAmI, num50);
						}
							...
							if (inventory[selectedItem].createTile == 19 && Main.smartDigEnabled)
							{
								...
								if (!flag7)
								{
									...
									if (num59 != -1)
									{
										...
										tile6 = Main.tile[num57 + num64, num58 + num65];
										if (tile6.active() && tile6.type == 19 && tile6.slope() == 0 && WorldGen.PlatformProperSides(num57 + num64, num58 + num65, acceptNonOpposing: true) <= 0)
										{
											WorldGen.SlopeTile(num57 + num64, num58 + num65, num59);
											num66 = tile6.slope();
											if (Main.netMode == 1)
							...
							if (Main.tileSolid[inventory[selectedItem].createTile])
							{
								for (int num72 = tileTargetX - 1; num72 <= tileTargetX + 1; num72++)
								{
									for (int num73 = tileTargetY - 1; num73 <= tileTargetY + 1; num73++)
									{
										...
										if (flag10)
										{
											WorldGen.KillTile(num72, num73, fail: true);
											if (Main.netMode == 1)
											{
			...
			if (inventory[selectedItem].stack > 1)
			{
				...
				for (int num84 = 0; num84 < 4; num84++)
				{
					...
					if (num93 > 0 && Main.tile[num91, num92].wallColor() != num93 && WorldGen.paintWall(num91, num92, (byte)num93, broadCast: true))
					{
						int num96 = num94;
			...
			if (num99 > 0 && Main.tile[num97, num98].wallColor() != num99 && WorldGen.paintWall(num97, num98, (byte)num99, broadCast: true))
			{
				int num102 = num100;
		...
		public void ItemCheck(int i)
		{
			...
			if (item.autoReuse && !noItems)
			{
				...
				{
					if (item.shoot > 0 && whoAmI != Main.myPlayer && controlUseItem && item.useStyle == 5)
					{
						ApplyAnimation(item);
						if (item.useSound > 0)
						{
			...
			if (controlUseItem && releaseUseItem && (item.headSlot > 0 || item.bodySlot > 0 || item.legSlot > 0))
			{
				if (item.useStyle == 0)
				{
					releaseUseItem = false;
				}
				if (base.position.X / 16f - (float)tileRangeX - (float)item.tileBoost <= (float)tileTargetX && (base.position.X + (float)width) / 16f + (float)tileRangeX + (float)item.tileBoost - 1f >= (float)tileTargetX && base.position.Y / 16f - (float)tileRangeY - (float)item.tileBoost <= (float)tileTargetY && (base.position.Y + (float)height) / 16f + (float)tileRangeY + (float)item.tileBoost - 2f >= (float)tileTargetY)
				{
					...
					if (Main.tile[num2, num3].active() && (Main.tile[num2, num3].type == 128 || Main.tile[num2, num3].type == 269))
					{
						...
						else if (frameY == 1 && item.bodySlot >= 0)
						{
							Main.blockMouse = true;
						...
						else if (frameY == 2 && item.legSlot >= 0)
						{
							Main.blockMouse = true;
			...
			if (controlUseItem && itemAnimation == 0 && releaseUseItem && item.useStyle > 0)
			{
				...
				if (item.fishingPole > 0)
				{
					for (int m = 0; m < 1000; m++)
					{
						...
						for (int n = 0; n < 58; n++)
						{
							...
							{
								Item item2 = new Item();
								item2.SetDefaults((int)Main.projectile[m].localAI[1]);
								if (item2.rare < 0)
								{
									flag5 = false;
								}
				...
				if (item.shoot == 6 || item.shoot == 19 || item.shoot == 33 || item.shoot == 52 || item.shoot == 113 || item.shoot == 320 || item.shoot == 333 || item.shoot == 383 || item.shoot == 491)
				{
					for (int num10 = 0; num10 < 1000; num10++)
					{
						if (Main.projectile[num10].active && Main.projectile[num10].owner == Main.myPlayer && Main.projectile[num10].type == item.shoot)
						{
							flag2 = false;
						}
					}
				...
				if (item.shoot == 106)
				{
					...
					{
						if (Main.projectile[num12].active && Main.projectile[num12].owner == Main.myPlayer && Main.projectile[num12].type == item.shoot)
						{
							num11++;
						}
					}
				...
				if (item.shoot == 272)
				{
					...
					for (int num14 = 0; num14 < 1000; num14++)
					{
						if (Main.projectile[num14].active && Main.projectile[num14].owner == Main.myPlayer && Main.projectile[num14].type == item.shoot)
						{
							num13++;
						}
					}
				...
				if (item.shoot == 13 || item.shoot == 32 || (item.shoot >= 230 && item.shoot <= 235) || item.shoot == 315 || item.shoot == 331 || item.shoot == 372)
				{
					...
					{
						if (Main.projectile[num15].active && Main.projectile[num15].owner == Main.myPlayer && Main.projectile[num15].type == item.shoot && Main.projectile[num15].ai[0] != 2f)
						{
							flag2 = false;
						}
					}
				...
				if (item.shoot == 332)
				{
					...
					{
						if (Main.projectile[num17].active && Main.projectile[num17].owner == Main.myPlayer && Main.projectile[num17].type == item.shoot && Main.projectile[num17].ai[0] != 2f)
						{
							num16++;
						}
					}
				...
				if (item.mana > 0 && flag2)
				{
					...
					if (whoAmI == Main.myPlayer && item.buffType != 0 && flag2)
					{
				...
				if (whoAmI == Main.myPlayer && item.type == 669)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 115)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 3060)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 3062)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 3577)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 425)
				{
				...
				if (whoAmI == Main.myPlayer && item.type == 753)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 994)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 1169)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 1170)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 1171)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 1172)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 1180)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 1181)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 1182)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 1183)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 1242)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 1157)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 1309)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 1311)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 1837)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 1312)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 1798)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 1799)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 1802)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 1810)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 1927)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 1959)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 2364)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 2365)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 3043)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 2420)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 2535)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 2551)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 2584)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 2587)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 2621)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 2749)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 3249)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 3474)
				{
					AddBuff(item.buffType, 3600);
				}
				if (whoAmI == Main.myPlayer && item.type == 3531)
				{
					AddBuff(item.buffType, 3600);
				}
				...
				if (item.shoot == 17 && flag2 && i == Main.myPlayer)
				{
					...
					{
						WorldGen.KillTile(num20, num21, fail: false, effectOnly: false, noItem: true);
				...
				if (flag2 && whoAmI == Main.myPlayer && item.shoot >= 0 && item.shoot < 651 && (ProjectileID.Sets.LightPet[item.shoot] || Main.projPet[item.shoot]))
				{
					if (ProjectileID.Sets.MinionSacrificable[item.shoot])
					{
						...
						float num25 = ItemID.Sets.StaffMinionSlotsRequired[item.type];
						float num26 = 0f;
						int num27 = 388;
						int num28 = -1;
					...
					else
					{
						...
						{
							if (Main.projectile[num31].active && Main.projectile[num31].owner == i && Main.projectile[num31].type == item.shoot)
							{
				...
				if (!Main.dedServ)
				{
					if (item.useStyle == 1)
					{
						if (item.type > -1 && Item.claw[item.type])
						{
							...
							{
								float num32 = 10f;
								itemLocation.X = base.position.X + (float)width * 0.5f + ((float)Main.itemTexture[item.type].Width * 0.5f - num32) * (float)direction;
								itemLocation.Y = base.position.Y + 26f + num;
							}
							else if ((double)itemAnimation < (double)itemAnimationMax * 0.666)
							{
								float num33 = 8f;
								itemLocation.X = base.position.X + (float)width * 0.5f + ((float)Main.itemTexture[item.type].Width * 0.5f - num33) * (float)direction;
								num33 = 24f;
							...
							{
								float num34 = 6f;
								itemLocation.X = base.position.X + (float)width * 0.5f - ((float)Main.itemTexture[item.type].Width * 0.5f - num34) * (float)direction;
								num34 = 20f;
						...
						else
						{
							if ((double)itemAnimation < (double)itemAnimationMax * 0.333)
							{
								...
								itemLocation.X = base.position.X + (float)width * 0.5f + ((float)Main.itemTexture[item.type].Width * 0.5f - num35) * (float)direction;
							...
							else if ((double)itemAnimation < (double)itemAnimationMax * 0.666)
							{
								...
								itemLocation.X = base.position.X + (float)width * 0.5f + ((float)Main.itemTexture[item.type].Width * 0.5f - num36) * (float)direction;
								num36 = 10f;
							...
							else
							{
								...
								itemLocation.X = base.position.X + (float)width * 0.5f - ((float)Main.itemTexture[item.type].Width * 0.5f - num37) * (float)direction;
								num37 = 10f;
								if (Main.itemTexture[item.type].Height > 32)
								{
									num37 = 10f;
					...
					else if (item.useStyle == 3)
					{
						...
						else
						{
							...
							itemLocation.Y = base.position.Y + 24f + num;
							float num38 = (float)itemAnimation / (float)itemAnimationMax * (float)Main.itemTexture[item.type].Width * (float)direction * item.scale * 1.2f - (float)(10 * direction);
					...
					else if (item.useStyle == 4)
					{
						...
						itemRotation = 0f;
						itemLocation.X = base.position.X + (float)width * 0.5f + ((float)Main.itemTexture[item.type].Width * 0.5f - 9f - itemRotation * 14f * (float)direction - 4f - (float)num39) * (float)direction;
						itemLocation.Y = base.position.Y + (float)Main.itemTexture[item.type].Height * 0.5f + 4f + num;
						if (gravDir == -1f)
						{
							itemRotation = 0f - itemRotation;
							itemLocation.Y = base.position.Y + (float)height + (base.position.Y - itemLocation.Y);
			...
			else if (item.holdStyle == 1 && !pulley)
			{
				...
				else if (item.type == 968)
				{
					...
					if (whoAmI == Main.myPlayer)
					{
						int num44 = (int)(itemLocation.X + (float)Main.itemTexture[item.type].Width * 0.8f * (float)direction) / 16;
						int num45 = (int)(itemLocation.Y + num + (float)(Main.itemTexture[item.type].Height / 2)) / 16;
						...
						if (Main.tile[num44, num45].active() && Main.tile[num44, num45].type == 215 && Main.tile[num44, num45].frameY < 54)
						{
							...
							if (miscTimer > 900)
							{
								...
								{
									if (inventory[num46].type == item.type && num46 != selectedItem && inventory[num46].stack < inventory[num46].maxStack)
									{
										Main.PlaySound(7);
				...
				{
					itemLocation.X = base.position.X + (float)width * 0.5f + (float)Main.itemTexture[item.type].Width * 0.18f * (float)direction;
				}
				else
				{
			...
			else if (item.holdStyle == 2 && !pulley)
			{
				if (item.type == 946)
				{
					itemRotation = 0f;
			...
			else if (item.holdStyle == 3 && !pulley && !Main.dedServ)
			{
				itemLocation.X = base.position.X + (float)width * 0.5f - (float)Main.itemTexture[item.type].Width * 0.5f - (float)(direction * 2);
				itemLocation.Y = MountedCenter.Y - (float)Main.itemTexture[item.type].Height * 0.5f;
				itemRotation = 0f;
			...
			if ((item.type == 105 || item.type == 713) && !wet && !pulley)
			{
				int maxValue2 = 20;
				if (itemAnimation > 0)
				{
			...
			if (i == Main.myPlayer)
			{
				...
				if (item.shoot > 0 && itemAnimation > 0 && itemTime == 0 && flag8)
				{
					...
					if (item.melee && shoot != 25 && shoot != 26 && shoot != 35)
					{
						speed /= meleeSpeed;
					}
					bool canShoot = false;
					...
					if (item.useAmmo > 0)
					{
						PickAmmo(item, ref shoot, ref speed, ref canShoot, ref Damage, ref KnockBack, ItemID.Sets.gunProj[item.type]);
					}
					else
					{
						canShoot = true;
					...
					if (item.type == 1254 && shoot == 14)
					{
						shoot = 242;
					}
					if (item.type == 1255 && shoot == 14)
					{
						shoot = 242;
					}
					if (item.type == 1265 && shoot == 14)
					{
						shoot = 242;
					}
					if (item.type == 3542)
					...
					if (canShoot)
					{
						...
						{
							Vector2 vector6 = Vector2.Normalize(new Vector2(num71, num72)) * 40f * item.scale;
						...
						else if (item.type == 1572 || item.type == 2366 || item.type == 3571 || item.type == 3569)
						{
							...
							bool flag10 = item.type == 3571 || item.type == 3569;
						...
						else if (item.shoot > 0 && (Main.projPet[item.shoot] || item.shoot == 72 || item.shoot == 18 || item.shoot == 500 || item.shoot == 650) && !item.summon)
						{
							for (int num182 = 0; num182 < 1000; num182++)
							{
								...
								else if (item.shoot == Main.projectile[num182].type)
								{
									Main.projectile[num182].Kill();
								}
							}
				...
				if (whoAmI == Main.myPlayer && (item.type == 509 || item.type == 510 || item.type == 849 || item.type == 850 || item.type == 851) && base.position.X / 16f - (float)tileRangeX - (float)item.tileBoost - (float)blockRange <= (float)tileTargetX && (base.position.X + (float)width) / 16f + (float)tileRangeX + (float)item.tileBoost - 1f + (float)blockRange >= (float)tileTargetX && base.position.Y / 16f - (float)tileRangeY - (float)item.tileBoost - (float)blockRange <= (float)tileTargetY && (base.position.Y + (float)height) / 16f + (float)tileRangeY + (float)item.tileBoost - 2f + (float)blockRange >= (float)tileTargetY)
				{
					showItemIcon = true;
				...
				if (((item.type >= 205 && item.type <= 207) || item.type == 1128 || item.type == 3031 || item.type == 3032) && base.position.X / 16f - (float)tileRangeX - (float)item.tileBoost <= (float)tileTargetX && (base.position.X + (float)width) / 16f + (float)tileRangeX + (float)item.tileBoost - 1f >= (float)tileTargetX && base.position.Y / 16f - (float)tileRangeY - (float)item.tileBoost <= (float)tileTargetY && (base.position.Y + (float)height) / 16f + (float)tileRangeY + (float)item.tileBoost - 2f >= (float)tileTargetY)
				{
					showItemIcon = true;
					if (itemTime == 0 && itemAnimation > 0 && controlUseItem)
					{
						if (item.type == 205 || (item.type == 3032 && Main.tile[tileTargetX, tileTargetY].liquidType() == 0))
						{
							...
							if (Main.tile[tileTargetX, tileTargetY].liquid > 0 && (num208 > 100 || item.type == 3032))
							{
								...
								for (int num212 = tileTargetX - 1; num212 <= tileTargetX + 1; num212++)
								{
									for (int num213 = tileTargetY - 1; num213 <= tileTargetY + 1; num213++)
									{
										if (num211 < 256 && Main.tile[num212, num213].liquidType() == num207)
										{
											...
											{
												Main.tile[num212, num213].lava(lava: false);
												Main.tile[num212, num213].honey(honey: false);
											}
											WorldGen.SquareTileFrame(num212, num213, resetFrame: false);
											if (Main.netMode == 1)
											{
						...
						else if (Main.tile[tileTargetX, tileTargetY].liquid < 200 && (!Main.tile[tileTargetX, tileTargetY].nactive() || !Main.tileSolid[Main.tile[tileTargetX, tileTargetY].type] || Main.tileSolidTop[Main.tile[tileTargetX, tileTargetY].type]))
						{
							...
							else if (item.type == 1128 && (Main.tile[tileTargetX, tileTargetY].liquid == 0 || Main.tile[tileTargetX, tileTargetY].liquidType() == 2))
							{
								Main.PlaySound(19, (int)base.position.X, (int)base.position.Y);
				...
				if ((item.pick > 0 || item.axe > 0 || item.hammer > 0) && base.position.X / 16f - (float)tileRangeX - (float)item.tileBoost <= (float)tileTargetX && (base.position.X + (float)width) / 16f + (float)tileRangeX + (float)item.tileBoost - 1f >= (float)tileTargetX && base.position.Y / 16f - (float)tileRangeY - (float)item.tileBoost <= (float)tileTargetY && (base.position.Y + (float)height) / 16f + (float)tileRangeY + (float)item.tileBoost - 2f >= (float)tileTargetY)
				{
					...
					if (Main.tile[tileTargetX, tileTargetY].active())
					{
						if ((item.pick > 0 && !Main.tileAxe[Main.tile[tileTargetX, tileTargetY].type] && !Main.tileHammer[Main.tile[tileTargetX, tileTargetY].type]) || (item.axe > 0 && Main.tileAxe[Main.tile[tileTargetX, tileTargetY].type]) || (item.hammer > 0 && Main.tileHammer[Main.tile[tileTargetX, tileTargetY].type]))
						{
							flag12 = false;
						}
						if (toolTime == 0 && itemAnimation > 0 && controlUseItem)
						{
							...
							if (Main.tileHammer[Main.tile[tileTargetX, tileTargetY].type])
							{
								...
								if (item.hammer > 0)
								{
									...
									if (Main.tile[tileTargetX, tileTargetY].type == 26 && (item.hammer < 80 || !Main.hardMode))
									{
										num216 = 0;
										Hurt(statLife / 2, -direction, pvp: false, quiet: false, Lang.deathMsg(name, -1, -1, -1, 4));
									}
							...
							{
								num216 = ((Main.tile[tileTargetX, tileTargetY].type != 80) ? (num216 + item.axe) : (num216 + item.axe * 3));
								if (item.axe > 0)
								{
									AchievementsHelper.CurrentlyMining = true;
									if (!WorldGen.CanKillTile(tileTargetX, tileTargetY))
							...
							if (item.hammer > 0 && Main.tile[tileTargetX, tileTargetY].active() && ((Main.tileSolid[Main.tile[tileTargetX, tileTargetY].type] && Main.tile[tileTargetX, tileTargetY].type != 10) || Main.tile[tileTargetX, tileTargetY].type == 314 || Main.tile[tileTargetX, tileTargetY].type == 351) && poundRelease)
							{
								flag12 = false;
								itemTime = item.useTime;
								num216 += (int)((double)item.hammer * 1.25);
								num216 = 100;
								...
								if (hitTile.AddDamage(num215, num216) >= 100)
								{
									...
									if (poundRelease)
									{
										...
										{
											if (Minecart.FrameTrack(num217, num218, pound: true) && Main.netMode == 1)
											{
								...
								{
									WorldGen.KillTile(tileTargetX, tileTargetY, fail: true, effectOnly: true);
									Main.PlaySound(0, tileTargetX * 16, tileTargetY * 16);
								}
							}
							else
					...
					if (flag12 && Main.tile[num227, num228].wall > 0 && (!Main.tile[num227, num228].active() || num227 != tileTargetX || num228 != tileTargetY || (!Main.tileHammer[Main.tile[num227, num228].type] && !poundRelease)) && toolTime == 0 && itemAnimation > 0 && controlUseItem && item.hammer > 0)
					{
						bool flag14 = true;
						if (!Main.wallHouse[Main.tile[num227, num228].wall])
						{
						...
						if (flag14)
						{
							...
							num216 += (int)((float)item.hammer * 1.5f);
							if (hitTile.AddDamage(num215, num216) >= 100)
							{
								hitTile.Clear(num215);
							...
							{
								WorldGen.KillWall(num227, num228, fail: true);
								if (Main.netMode == 1)
								{
						...
						if ((Main.tile[num239, num240].wall != 87 || !((double)num240 > Main.worldSurface) || NPC.downedPlantBoss) && !Collision.SolidCollision(vector19, width, height))
						{
							...
							if (chaosState)
							{
								...
								if (Lang.lang <= 1)
								{
									...
									if (statLife <= 0)
									{
										KillMe(1.0, 0, pvp: false, deathText);
									}
								}
								else if (statLife <= 0)
								{
									KillMe(1.0, 0, pvp: false, "");
								}
								lifeRegenCount = 0;
								lifeRegenTime = 0;
							}
			...
			if (((item.damage >= 0 && item.type > 0 && !item.noMelee) || item.type == 1450 || item.type == 1991 || item.type == 3183 || item.type == 3542) && itemAnimation > 0)
			{
				bool flag15 = false;
				Rectangle r2 = new Rectangle((int)itemLocation.X, (int)itemLocation.Y, 32, 32);
				if (!Main.dedServ)
				{
					r2 = new Rectangle((int)itemLocation.X, (int)itemLocation.Y, Main.itemTexture[item.type].Width, Main.itemTexture[item.type].Height);
				}
				...
				if (!flag15)
				{
					...
					if (frostBurn && item.melee && !item.noMelee && !item.noUseGraphic && Main.rand.Next(2) == 0)
					{
					...
					if (item.melee && !item.noMelee && !item.noUseGraphic && meleeEnchant > 0)
					{
						if (meleeEnchant == 1)
						{
							if (Main.rand.Next(3) == 0)
					...
					if (magmaStone && item.melee && !item.noMelee && !item.noUseGraphic && Main.rand.Next(3) != 0)
					{
					...
					if (Main.myPlayer == i && (item.type == 1991 || item.type == 3183))
					{
						for (int num274 = 0; num274 < 200; num274++)
						{
							if (Main.npc[num274].active && Main.npc[num274].catchItem > 0)
							{
								...
								if (r2.Intersects(value6) && (item.type == 3183 || Main.npc[num274].noTileCollide || Collision.CanHit(base.position, width, height, Main.npc[num274].position, Main.npc[num274].width, Main.npc[num274].height)))
								{
					...
					{
						int num275 = (int)((float)item.damage * meleeDamage);
						float knockBack = item.knockBack;
						float num276 = 1f;
						if (kbGlove)
						{
						...
						if (item.type != 3183)
						{
							for (int num284 = 0; num284 < 200; num284++)
							{
								...
								if (!Main.npc[num284].dontTakeDamage)
								{
									...
									if (item.type == 1826 && (Main.npc[num284].value > 0f || (Main.npc[num284].damage > 0 && !Main.npc[num284].friendly)))
									{
								...
								else if (Main.npc[num284].type == 63 || Main.npc[num284].type == 64 || Main.npc[num284].type == 103 || Main.npc[num284].type == 242)
								{
									...
									{
										Hurt((int)((double)Main.npc[num284].damage * 1.3), -direction, pvp: false, quiet: false, Lang.deathMsg(name, -1, -1, -1, 4));
										Main.npc[num284].immune[i] = itemAnimation;
										attackCD = (int)((double)itemAnimationMax * 0.33);
									}
								}
							...
							if (hostile)
							{
								for (int num294 = 0; num294 < 16; num294++)
								{
									...
									StatusPvP(item.type, num294);
									OnHit(Main.player[num294].Center.X, Main.player[num294].Center.Y, Main.player[num294]);
									int num296 = (int)Main.player[num294].Hurt(num295, direction, pvp: true, quiet: false, "", flag18);
									if (inventory[selectedItem].type == 3211)
									{
									...
									if (item.type == 1826 && Main.npc[num294].value > 0f)
									{
							...
							if (item.type == 787 && (itemAnimation == (int)((double)itemAnimationMax * 0.1) || itemAnimation == (int)((double)itemAnimationMax * 0.3) || itemAnimation == (int)((double)itemAnimationMax * 0.5) || itemAnimation == (int)((double)itemAnimationMax * 0.7) || itemAnimation == (int)((double)itemAnimationMax * 0.9)))
							{
								float num301 = 0f;
								float num302 = 0f;
								float num303 = 0f;
			...
			if (whoAmI == Main.myPlayer)
			{
				...
				if (itemTime == 0 && itemAnimation > 0 && item.type == 1844 && !Main.dayTime && !Main.pumpkinMoon && !Main.snowMoon)
				{
					itemTime = item.useTime;
					Main.PlaySound(15, (int)base.position.X, (int)base.position.Y, 0);
					if (Main.netMode != 1)
				...
				if (itemTime == 0 && itemAnimation > 0 && item.type == 1958 && !Main.dayTime && !Main.pumpkinMoon && !Main.snowMoon)
				{
					itemTime = item.useTime;
					Main.PlaySound(15, (int)base.position.X, (int)base.position.Y, 0);
					if (Main.netMode != 1)
				...
				if (itemTime == 0 && itemAnimation > 0 && item.makeNPC > 0 && controlUseItem && base.position.X / 16f - (float)tileRangeX - (float)item.tileBoost <= (float)tileTargetX && (base.position.X + (float)width) / 16f + (float)tileRangeX + (float)item.tileBoost - 1f >= (float)tileTargetX && base.position.Y / 16f - (float)tileRangeY - (float)item.tileBoost <= (float)tileTargetY && (base.position.Y + (float)height) / 16f + (float)tileRangeY + (float)item.tileBoost - 2f >= (float)tileTargetY)
				{
					...
					{
						NPC.ReleaseNPC(num305, num306, item.makeNPC, item.placeStyle, whoAmI);
					}
				}
			...
			int num320 = (item.createTile >= 0) ? ((int)((float)item.useTime * tileSpeed)) : ((item.createWall <= 0) ? item.useTime : ((int)((float)item.useTime * wallSpeed)));
			if (itemTime == num320 && item.consumable)
			{
				bool flag20 = true;
		...
		public void PickTile(int x, int y, int pickPower)
		{
			...
			if (hitTile.AddDamage(tileId, num, updateAmount: false) >= 100 && (tile.type == 2 || tile.type == 23 || tile.type == 60 || tile.type == 70 || tile.type == 109 || tile.type == 199 || Main.tileMoss[tile.type]))
			{
				num = 0;
			}
		...
		public void TeleportationPotion()
		{
			...
			while (!flag && num < 1000)
			{
				...
				if (Collision.TileCollision(vector - vector3, vector3, base.width, height, fallThrough: false, fall2: false, (int)gravDir) != vector3)
				{
					continue;
				}
		...
		public void UpdateTouchingTiles()
		{
			...
			if (!Collision.IsClearSpotHack(position + velocity, 16f, width, height, fallThrough: false, fall2: false, (int)gravDir, checkCardinals: true, checkSlopes: true))
			{
			...
			if (!Collision.IsClearSpotHack(position, Math.Abs(velocity.Y), width, height, fallThrough: false, fall2: false, (int)gravDir, checkCardinals: true, checkSlopes: true))
			{
