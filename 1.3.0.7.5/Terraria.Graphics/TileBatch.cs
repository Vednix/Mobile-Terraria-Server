...
namespace Terraria.Graphics
{
	public class TileBatch
	{
		...
		public void Draw(Texture2D texture, Vector2 position, VertexColors colors)
		{
			...
			destination.Z = 1f;
			destination.W = 1f;
			InternalDraw(texture, ref destination, scaleDestination: true, ref nullRectangle, ref colors, ref vector2Zero, SpriteEffects.None);
		}
		...
		public void Draw(Texture2D texture, Vector2 position, Rectangle? sourceRectangle, VertexColors colors, Vector2 origin, float scale, SpriteEffects effects)
		{
			...
			destination.Z = scale;
			destination.W = scale;
			InternalDraw(texture, ref destination, scaleDestination: true, ref sourceRectangle, ref colors, ref origin, effects);
		}

		public void Draw(Texture2D texture, Vector4 destination, VertexColors colors)
		{
			InternalDraw(texture, ref destination, scaleDestination: false, ref nullRectangle, ref colors, ref vector2Zero, SpriteEffects.None);
		}
		...
		public void Draw(Texture2D texture, Rectangle destinationRectangle, Rectangle? sourceRectangle, VertexColors colors)
		{
			...
			InternalDraw(texture, ref destination, scaleDestination: false, ref sourceRectangle, ref colors, ref vector2Zero, SpriteEffects.None);
		}
