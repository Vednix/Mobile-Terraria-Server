...
namespace Terraria.GameContent.Biomes
{
	internal class EnchantedSwordBiome : MicroBiome
	{
		public override bool Place(Point origin, StructureMap structures)
		{
			...
			WorldUtils.Gen(point, new Shapes.Slime(20, num2, 1f), Actions.Chain(new Modifiers.Blotches(2, 0.4), new Actions.ClearTile(frameNeighbors: true).Output(shapeData)));
